...
import type { AllowedFocusPerson } from '@/shared/types/api';
import type { Person, TreePerspective } from '@/shared/types/person';
...
import { authPersonToLocal } from '@/shared/utils/personApiMapper';
import { shortPersonName } from '@/shared/utils/personDisplayName';
import {
  getPersonsForPerspective,
  getVisiblePersonIds,
} from '@/shared/utils/familyPerspective';
...
const THEMES: Record<TreePerspective, PerspectiveTheme> = {
  self: {
    ...
    accentBg: 'bg-primary-50 dark:bg-primary-500/15',
    accentBorder: 'border-primary-400 dark:border-primary-500/40',
    accentText: 'text-primary-700 dark:text-primary-300',
    bannerBg: 'bg-primary-50 dark:bg-primary-500/10',
    bannerBorder: 'border-primary-200 dark:border-primary-500/25',
    ring: 'ring-primary-400',
  },
  spouse: {
    accent: 'bg-secondary-500',
    accentBg: 'bg-secondary-100 dark:bg-secondary-500/15',
    accentBorder: 'border-secondary-500 dark:border-secondary-500/40',
    accentText: 'text-brand-700 dark:text-secondary-200',
    bannerBg: 'bg-secondary-100 dark:bg-secondary-500/10',
