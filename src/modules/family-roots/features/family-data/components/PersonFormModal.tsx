...
import type { Gender, LifeStatus, Person, Religion } from '@/shared/types/person';
import {
  buildAddressFromFields,
  getGoogleMapsSearchUrl,
} from '@/shared/utils/personContact';
import { useDebouncedValue } from '@/shared/hooks/useDebouncedValue';
import { usePersonRelationSearch } from '@/shared/hooks/usePersonRelationSearch';
import type { PersonListScope } from '@/shared/types/api';
import {
  resolveAddressCoordinates,
  type GeocodeSource,
} from '@/shared/utils/addressGeocoding';

const RELATION_SEARCH_DEBOUNCE_MS = 400;

const AddressPinPicker = lazy(() =>
  import('@/shared/components/ui/AddressPinPicker').then((m) => ({
